...
const registerUser = async (req, res) => {
    try {
        ...
        req.body.role = 'user';
        const { fullName, emailId, password, phoneNumber, gender } = req.body;
...
const logOut = async (req, res) => {
    try {
        ...
        res.clearCookie("token", { httpOnly: true, secure: true, sameSite: "Strict", expires: new Date(Date.now()) })
