...
const AttemptTest = () => {
  ...
  const submitTest = async () => {
    try {
      ...
      alert("some error  occured to submit the test  " || error.response?.data?.error );
      navigate("/")
            ...
            {questions.map((_, idx) => {
              ...
              return (
                <button
                  ...
                  className={`btn btn-sm font-semibold rounded-lg border transition-all ${isCurrent
          ...
          <div className="card bg-slate-900 border border-slate-800 shadow-xl overflow-hidden">
            ...
            <div className="px-6 py-4 bg-slate-950/50 border-t border-slate-800 flex justify-between items-center">
              ...
              <button
                ...
                disabled={submitting}
                className={`btn btn-md gap-2 normal-case border-none text-white ${index === lastIndex
